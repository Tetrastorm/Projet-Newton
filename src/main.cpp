...
int main(void)
{
    ...
    try {
        ...
        planet_list.push_back(factory.MakePlanet(sf::Vector2<float>(static_cast<float>(WINDOW_SIZE[0]) * 0.85f, static_cast<float>(WINDOW_SIZE[1]) * 0.2f), 0.25f, sf::Vector2<float>(0.5f, 0.5f), sf::Vector2<float>(5.f, 0.f), "resources/gaz_planet_1.png", 100.f, 0.25f, planet_list[0]));
        planet_list.push_back(factory.MakePlanet(sf::Vector2<float>(static_cast<float>(WINDOW_SIZE[0]) * 0.90f, static_cast<float>(WINDOW_SIZE[1]) * 0.90f), 1.f, sf::Vector2<float>(0.3f, 0.3f), sf::Vector2<float>(4.f, 2.f), "resources/rock_planet_1.png", 100.f, 1.f, planet_list[0]));
